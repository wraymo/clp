...
namespace streaming_archive { namespace writer {
    ...
    private:
         ...
         */
        void append_file_contents_to_segment (Segment& segment, std::vector<Segment*>& column_segments, ArrayBackedPosIntSet<logtype_dictionary_id_t>& logtype_ids_in_segment,
        ...
        JsonTypeDictionaryEntry m_jsontype_dict_entry;
        ...
        ArrayBackedPosIntSet<jsontype_dictionary_id_t> m_jsontype_ids_in_segment_for_files_with_timestamps;
        ...
        std::unordered_set<jsontype_dictionary_id_t> m_jsontype_ids_for_file_with_unassigned_segment;
        ...
        ArrayBackedPosIntSet<jsontype_dictionary_id_t> m_jsontype_ids_in_segment_for_files_without_timestamps;
