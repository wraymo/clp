...
namespace streaming_archive { namespace writer {
    ...
    void Archive::write_json_msg (File& file, epochtime_t timestamp, ordered_json& message, size_t num_uncompressed_bytes, std::vector<ordered_json*>& extracted_values) {
        ...
        EncodedVariableInterpreter::encode_and_add_to_dictionary(message, m_jsontype_dict_entry, m_logtype_dict, m_var_dict, encoded_vars);
        jsontype_dictionary_id_t jsontype_id;
        if (m_jsontype_dict.add_occurrence(m_jsontype_dict_entry, jsontype_id)) {
            m_jsontype_dict_entry = make_unique<JsonTypeDictionaryEntry>();
        }
    ...
    void Archive::append_file_contents_to_segment (Segment& segment, std::vector<Segment*>& column_segments, ArrayBackedPosIntSet<logtype_dictionary_id_t>& logtype_ids_in_segment,
                                                   ArrayBackedPosIntSet<jsontype_dictionary_id_t>& jsontype_ids_in_segment,
                                                   ArrayBackedPosIntSet<variable_dictionary_id_t>& var_ids_in_segment, std::vector<File*>& files_in_segment);
    {
        ...
        m_file->append_to_segment(m_logtype_dict, m_jsontype_dict, segment, column_segments);
    ...
    void Archive::append_file_to_segment () {
        ...
        if (m_file->has_ts_pattern()) {
            ...
            m_jsontype_ids_in_segment_for_files_with_timestamps.insert_all(m_jsontype_ids_for_file_with_unassigned_segment);
            ...
            append_file_contents_to_segment(m_segment_for_files_with_timestamps, m_logtype_ids_in_segment_for_files_with_timestamps,
                                            m_jsontype_ids_in_segment_for_files_with_timestamps,
        ...
        m_jsontype_ids_for_file_with_unassigned_segment.clear();
    ...
    void Archive::close_segment_and_persist_file_metadata (Segment& segment, std::vector<File*>& files,
                                                           ...
                                                           ArrayBackedPosIntSet<jsontype_dictionary_id_t>& segment_jsontype_ids,
                                                           ArrayBackedPosIntSet<variable_dictionary_id_t>& segment_var_ids)
    {
        ...
        // }
        // m_jsontype_dict.write_uncommitted_entries_to_disk();
        m_jsontype_dict.write_header_and_flush_to_disk();
